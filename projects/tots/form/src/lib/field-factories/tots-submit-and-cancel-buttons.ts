...
export class TotsSubmitAndCancelButtons extends TotsFieldForm {
	constructor(key:string, submitCaption:string, cancelCaption?:string, matIcon?:string, submitMatColor?:string, submitMatDirective?:TotsFormButtonMatDirective, cancelMatDirective?:TotsFormButtonMatDirective) {
