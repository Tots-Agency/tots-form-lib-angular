...
} from 'projects/tots/date-field-form/src/public-api';
import {
  TotsFormApiService,
  TotsFormModalApiConfig,
} from 'projects/tots/form-api/src/public-api';
...
export class FormComponentComponent implements OnInit {
  ...
  configForm() {
    this.fields = [
      // Campo string
      {
        ...
        extra: { caption: 'Este se mostrara publicamente...', icon: 'home' },
      ...
      // Campo Avatar
      {
        ...
        extra: {
          ...
          remove_text: 'Eliminar imagen',
          service: {
            upload: () => {
              return of({
                url: 'https://storage.googleapis.com/tots-send-public/Frame%2028.png',
              });
            },
          },
        },
      ...
      // Campo Date
      {
        ...
        label: 'Start date',
        extra: {
          /*minDate: new Date(),*/ format_output: 'YYYY-MM-DDTHH:mm:ss',
        },
      },
      // Campo Files List
      {
        key: 'attachments',
        component: FilesListFieldComponent,
        label: 'Attachments',
        extra: {
          textAddButton: '+ Add new file',
      ...
      {
        key: 'file_one',
        component: OneFileFieldComponent,
        label: 'Upload SIF File',
        extra: {
          display_key: 'filename',
          service: {
            upload: () => {
      ...
      {
        key: 'integer',
        component: IntegerFieldComponent,
      ...
      // Campo Autocompleete List
      {
        ...
        extra: {
          ...
          is_show_photo: false,
          placeholder_photo:
            'https://storage.googleapis.com/tots-send-public/Frame%2028.png',
          obs: this.customerAutocompleteObsProcessed.bind(this),
        },
      },
      // Campo Files List
      {
        key: 'photos',
        component: PhotosFieldComponent,
        label: 'Upload photo',
        extra: {
          display_key: 'url',
          service: {
      ...
      {
        key: 'datepicker_time',
        component: DatepickerAndTimeEndFieldComponent,
        label: 'Date picker and time',
        extra: {
          field_key_end: 'datepicker_time_end',
        ...
        extra: {
          ...
          suggestions: () => {
            return [
              ...
              {
                label: 'Test2',
                kind: (<any>window).monaco.languages.CompletionItemKind
                  .Variable,
                insertText: '{{Test2}}',
                preselect: true,
      ...
      {
        key: 'select_obs',
        component: SelectObsFieldComponent,
    ...
    this.fields = [
      ...
      },
      {
        ...
        extra: {
          selected_key: 'id',
          filter_key: 'title',
          obs: this.customerAutocompleteListProcessed.bind(this),
          display_key: 'title',
          is_show_photo: true,
          placeholder_photo:
            'https://storage.googleapis.com/tots-send-public/Frame%2028.png',
  ...
  onClickOpenModal() {
    ...
    config.fields = [
      // Campo string
      {
        ...
        label: 'Titulo',
        validators: [Validators.required],
        extra: { caption: 'Este se mostrara publicamente...' },
      },
      // Campo de selector normal
      {
        key: 'type',
  ...
  mentionOnSelect(editor: any, item: any, insertItem: any) {
    ...
    editor.quillEditor.insertText(
      editor.quillEditor.getLength() - 1,
      '',
      'user'
    );
  }
  ...
  customerAutocompleteObsProcessed(query?: string): Observable<Array<any>> {
    ...
    if (query == undefined || query == '') {
      return of(customers).pipe(delay(1500)); // Simular delay de 1.5 segundos
    }
    ...
    ).pipe(delay(1500)); // Simular delay de 1.5 segundos
  }

  customerAutocompleteListProcessed(query?: string): Observable<Array<any>> {
    console.log('Autocomplete List Query:', query);

    let customers = [
      { id: 1, title: 'Apple Inc.' },
      { id: 2, title: 'Microsoft Corporation' },
      { id: 3, title: 'Google LLC' },
      { id: 4, title: 'Amazon.com Inc.' },
      { id: 5, title: 'Facebook Inc.' },
      { id: 6, title: 'Netflix Inc.' },
      { id: 7, title: 'Tesla Inc.' },
      { id: 8, title: 'Adobe Inc.' },
      { id: 9, title: 'Salesforce Inc.' },
      { id: 10, title: 'Oracle Corporation' },
    ];

    if (query == undefined || query == '') {
      return of(customers).pipe(delay(2000)); // Simular delay de 2 segundos
    }
    ...
    ).pipe(delay(2000)); // Simular delay de 2 segundos
  }
