...
import { TotsFormModule, TOTS_FORM_DEFAULT_CONFIG, TOTS_STRING_ARRAY_CONFIG, TOTS_FORM_BUTTONS_CONFIG } from 'projects/tots/form/src/public-api';
...
import { totsFormButtonsConfig } from './helpers/tots-form-buttons-config';
...
@NgModule({
  ...
  providers: [
    ...
    },
    {
      ...
      useValue: totsFormButtonsConfig
    }
  ],
